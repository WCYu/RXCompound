...
public class MoneyView extends RelativeLayout {
    ...
    public MoneyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.widget_walletitem, this, true);
...
//    public void setTextColor(int textposition,int colortype){//colortype颜色种类，1：绿色
//        switch (colortype){
//            case 1:
//                switch (textposition){
//                    case 3:
//                        tvTypethreemoney.setTextColor(this.getResources().getColor(R.color.colorPrimarys));
//                        break;
//                }
//                break;
//        }
