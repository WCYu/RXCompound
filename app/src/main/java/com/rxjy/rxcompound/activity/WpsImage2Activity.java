...
public class WpsImage2Activity extends BaseActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public void initData() {
        if(App.titletopcolor==1){
            App.titletopcolor=0;
            rlTitletop.setBackgroundColor(getResources().getColor(R.color.colorredbg));
        }
