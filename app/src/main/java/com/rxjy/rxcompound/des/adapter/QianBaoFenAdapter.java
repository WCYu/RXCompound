 ...
 */
    ...
    public class QianBaoFenAdapter extends SingleBaseAdapter<QianbaoFenInfo.BodyBean, QianBaoFenAdapter.ViewHolder> {
    ...
    public QianBaoFenAdapter(Context context, List<QianbaoFenInfo.BodyBean> datas) {
        super(context, datas);
        map = new HashMap<>();
    }
    ...
    @Override
    public void onBindView(int position, QianbaoFenInfo.BodyBean data, ViewHolder holder) {
