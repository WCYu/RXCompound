 ...
 */
public class YusuanFragment extends BaseFragment<HetongPresenter> implements HetongContract.View,View.OnClickListener,AdapterView.OnItemClickListener  {
    ...
    public void onResume()
    {
        ...
        mPresenter.GetAllImages(clientInfo.getCi_rwdid(),2);
    }
