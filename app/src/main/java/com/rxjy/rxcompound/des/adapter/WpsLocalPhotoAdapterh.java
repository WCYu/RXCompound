 ...
 */
public class WpsLocalPhotoAdapterh extends SingleBaseAdapter<String, WpsLocalPhotoAdapterh.ViewHolder> {
    /**
     * 用户选择的图片，存储为图片的完整路径
     */
    ...
    public WpsLocalPhotoAdapterh(Context context, List<String> datas) {
        super(context, datas);
    }
