...
public class TuzhiFragment extends BaseFragment<HetongPresenter> implements HetongContract.View,View.OnClickListener,AdapterView.OnItemClickListener  {
    ...
    public void onResume()
    {
        ...
        mPresenter.GetAllImages(clientInfo.getCi_rwdid(),3);
    }
    ...
    public void onClick(View view)
    {
        switch (view.getId())
        {
            ...
            case R.id.choosePhoto:
                ...
                Intent albumIntent = new Intent(getActivity(), DesAlbumActivityh.class);
...
//        }else {
            ...
            List<AllImagesInfo.Album.image> imageList = info.getChildList();
        Intent albumIntent;
        if (info.getCatalogID()==66||info.getCatalogID()==90){
