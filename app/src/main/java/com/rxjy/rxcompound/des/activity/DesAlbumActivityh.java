...
public class DesAlbumActivityh extends BaseActivity<DesAlbumPresenter> implements DesAlbumContract.View, AdapterView.OnItemClickListener
{
    ...
    private void initPhotoData()
    {
        ...
        mAdapter = new DesAlbumAdapter(this, imgList, this,picsize);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l)
    {
        ...
        if (position == mAdapter.getCount() - 1&&picsize!=1)
        {
            if (position == imgList.size() - 1&&picsize!=1)
            {
                if (imgList.size() != 0)
                {
                    imgList.remove(imgList.size() - 1);
                }
                Intent intent = new Intent(DesAlbumActivityh.this, WpsLocalPhotoActivityh.class);
                intent.putExtra(Constants.IS_ONLY_ONE_IMAGE, Constants.ONLY_ONE_PHOTO);
