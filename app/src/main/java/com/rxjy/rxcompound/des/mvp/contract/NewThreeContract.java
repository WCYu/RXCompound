...
public interface NewThreeContract {
    interface View extends BaseView {
        ...
        void responseGetNewThree(NewThreeInfo.BodyBean info);

        void responseGetNewThreeError(String msg);
    ...
    abstract class Presenter extends BasePresenter<View, Model> {
        public abstract void GetNewThree(
                String rwdid
        );
