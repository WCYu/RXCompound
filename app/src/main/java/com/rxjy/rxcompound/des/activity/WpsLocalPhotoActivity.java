...
import com.rxjy.rxcompound.des.adapter.WpsLocalPhotoAdapter;
...
public class WpsLocalPhotoActivity extends BaseActivity<WpsLocalPhotoPresenter> implements IWpsLocalPhotoContract.View {
    @Bind(R.id.iv_back)
     ...
     * 图片列表适配器
     */
    private WpsLocalPhotoAdapter mWpsLocalPhotoAdapter;
    /**
     * 被选择的照片的集合
     */
    ...
    private void initPhoto() {
        ...
        mWpsLocalPhotoAdapter = new WpsLocalPhotoAdapter(this, mImgs);
...
//    }
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            showToast("拍摄成功");
            //获取图片
            mPresenter.getPhotoes(WpsLocalPhotoActivity.this);
        }
    };
