...
public class KaigongjiaodiActivity extends BaseActivity<KaigongPresenter> implements KaiGongContract.View, AdapterView.OnItemClickListener {
    ...
    protected void onResume() {
        ...
        mPresenter.GetUCAllImages(bodyBean.getCi_RwdId(), 1);
    }
