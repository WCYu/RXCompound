...
public class DesAlbumActivity extends BaseActivity<DesAlbumPresenter> implements DesAlbumContract.View, AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        if (position == mAdapter.getCount() - 1) {
            if (position == imgList.size() - 1) {
                ...
                Intent intent = new Intent(DesAlbumActivity.this, WpsLocalPhotoActivity.class);
