...
public class IdentityInfoModel implements IdentityInfoContract.Model {
    ...
    @Override
    public Observable<String> upDataMessage(String Phone, String Type, String IdCard, String IdCardName, String Birthday, String IdCardAddress, String NowAddress, String Marriage, String Xueli) {
        return ApiEngine.getInstance().getRsApiService()
                .getUpdateMessagesnew(Phone, Type, IdCard, IdCardName, Birthday, IdCardAddress, NowAddress, Marriage, Xueli)
                .compose(RxSchedulers.<String>switchThread());
    }
