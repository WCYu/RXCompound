...
public class DesIdentityInfoModel implements DesIdentityInfoContract.Model{
    @Override
    public Observable<String> updateDesIdentityMessage(String card_no, String Type, String phone, String nick_name, String sex, String id_card, String birthday, String living_place, String education, String email) {
        return ApiEngine.getInstance().getRsApiService()
                .getUpdateDesMessage(card_no, Type, phone, nick_name, sex, id_card, birthday, living_place, education, email)
